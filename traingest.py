...
img_size = 50
num_channels = 3
train_path='F:/Project/Hand-Gesture-Recognition-Using-CNN-master/Traindata'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, 'F:/Project/Hand-Gesture-Recognition-Using-CNN-master/handgest_1') 
